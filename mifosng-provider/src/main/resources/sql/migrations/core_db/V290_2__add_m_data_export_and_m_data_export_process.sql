...
('dataexport','CREATE_DATAEXPORT','DATAEXPORT','READ',0),
('dataexport','CREATE_DATAEXPORT','DATAEXPORT','DELETE',0),
('dataexport','CREATE_DATAEXPORTPROCESS','DATAEXPORTPROCESS','CREATE',0);
('dataexport','CREATE_DATAEXPORTPROCESS','DATAEXPORTPROCESS','READ',0);
('dataexport','CREATE_DATAEXPORTPROCESS','DATAEXPORTPROCESS','DELETE',0);