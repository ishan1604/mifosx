...
public class EmailCampaignData {
    ...
    private EmailCampaignData(final Long id, final String campaignName, final Integer campaignType, final Long runReportId,
                              final String paramValue, final EnumOptionData campaignStatus,
                              final String message, final DateTime nextTriggerDate, final LocalDate lastTriggerDate, final EmailCampaignTimeLine emailCampaignTimeLine,
    ...
    public static EmailCampaignData instance(final Long id, final String campaignName, final Integer campaignType, final Long runReportId,
        ...
        return new EmailCampaignData(id,campaignName,campaignType,runReportId,paramValue,
                campaignStatus,message,nextTriggerDate,lastTriggerDate,emailCampaignTimeLine,recurrenceStartDate,recurrence);
    }
